...
namespace GAS.UI.CtrlView
{
    ...
    public partial class C_Forecast : UserControl
    {
        ...
        {
            FormView.F_ErrShow errshow = new FormView.F_ErrShow();
            errshow.Show();
            errshow.Dispose();
        }

        private void C_Forecast_Load(object sender, EventArgs e)
        {
        ...
        {
            FormView.F_SetFCSTPara setpara = new FormView.F_SetFCSTPara();
            setpara.Show();
            setpara.Dispose();
        }
